...
if(!isset($_GET["town"]) && !isset($_GET["from_year"]) &&!isset($_GET["to_year"]) && !isset($_GET["cee_csfr_security"]) &&  !isset($_GET["cee_csfr_controller"])  ) {
                ...
                <div class="px-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Analysis By Village - <?= $town ?></h4> <br>
