            ...
            <div class="main-menu">
                ...
                <div data-simplebar="">
                    <ul class="app-menu">
                        ...
                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='index.htm'>
                ...
                <div class="px-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Create School</h4>
                                </div>
                                <div class="col-lg-6">
                                            ...
                                            <div class="col-12">
                                                <div class="p-2">
                                                    <form class="form-horizontal" role="form">
                                                        <div class="mb-2 row">
                                                            <label class="col-md-12 col-form-label" for="simpleinput">School Full Name</label>
                                                            <div class="col-md-10">
                                                                <input type="text" id="simpleinput" class="form-control" name="full_name">
                                                            </div>
                                                        </div>
                                                        <div class="mb-2 row">
                                                            <label class="col-md-12 col-form-label" for="example-email">Code</label>
                                                            <div class="col-md-10">
                                                                <input type="text" id="example-email" placeholder="e.g udoka" class="form-control" name="code">
                                                            </div>
                                                        </div>
                                                          
                                                        <div class="mb-2 row">
                                                            <label class="col-md-2 col-form-label" for="example-email">Description</label>
                                                            <textarea class="form-control"  id="floatingTextarea" style="height: 100px" name="descriptio" ></textarea>
                                                        </div>
                                                        <div>
